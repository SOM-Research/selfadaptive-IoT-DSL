...
/*package*/ class Actuator_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new regionsListHandler_ilbjvu_a3a0(myNode, getEditorContext());
  ...
  private static class regionsListHandler_ilbjvu_a3a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public regionsListHandler_ilbjvu_a3a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(regionsListHandler_ilbjvu_a3a0.this.getNode(), LINKS.regions$svWv));
      try {
