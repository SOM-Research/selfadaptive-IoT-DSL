...
public final class Sensor_Type__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x23381bd32c6859b3L, "IoT.structure.Sensor_Type");

  public static final SMethod<Boolean> checkRegion_id5c6$$01W3Px = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("checkRegion").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("5c6$$01W3Px").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept Sensor$8w = MetaAdapterFactory.getConcept(0x222ccd66f9d64014L, 0x8569354bddee8138L, 0x23381bd32c6875c5L, "IoT.structure.Sensor");
  }
}
