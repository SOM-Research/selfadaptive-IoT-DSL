...
public class Container_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append("apiVersion: apps/v1");
    tgs.newLine();
    tgs.append("kind: Deployment");
    tgs.newLine();
    tgs.append("metadata:");
    tgs.newLine();
    ...
    ctx.getBuffer().area().increaseIndent();
    tgs.indent();
    tgs.append("Testtttttttttttttttttttttt");
    tgs.newLine();
    ctx.getBuffer().area().decreaseIndent();
    tgs.indent();
    tgs.append("replicas: 1");
    tgs.newLine();
    tgs.indent();
    tgs.append("selector:");
    tgs.newLine();
