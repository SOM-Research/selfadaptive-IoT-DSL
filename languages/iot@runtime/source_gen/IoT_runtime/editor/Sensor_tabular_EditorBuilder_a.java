...
/*package*/ class Sensor_tabular_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public HeaderGrid createStaticHeader_8gfsze_a7a0(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Communic.", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Communic."), cell);
    header.setLabel("Communic.");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
